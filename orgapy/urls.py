...
urlpatterns = [
    ...
    path("sheets/<sid>/pin", views.view_toggle_sheet_pin, name="toggle_sheet_pin"),
    ...
    path("edit/<active>/<object_id>", views.view_edit, name="edit"),
    path("export/<active>/<object_id>", views.view_export, name="export"),
    path("core/delete/<active>/<object_id>", views.view_delete, name="delete"),
    path("core/pin/<active>/<object_id>", views.view_toggle_pin, name="toggle_pin"),
    path("core/public/<active>/<object_id>", views.view_toggle_public, name="toggle_public"),
    path("share/<active>/<nonce>", views.view_share, name="share"),
