...
urlpatterns = [
    ...
    path("quotes/<object_id>", views.view_quote, name="quote"),
    path("quotes/<object_id>/edit", views.view_edit_quote, name="edit_quote"),
    ...
    path("sheets/group/<object_id>", views.view_sheet_group, name="sheet_group"),
    path("sheets/group/<object_id>/edit", views.view_edit_sheet_group, name="edit_sheet_group"),
    path("sheets/group/<object_id>/delete", views.view_delete_sheet_group, name="delete_sheet_group"),
