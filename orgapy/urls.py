...
urlpatterns = [
    ...
    path("projects/all", views.view_projects_all, name="projects_all"),
    ...
    path("notes/<object_id>/hidden", views.view_toggle_note_hidden, name="toggle_note_hidden"),
    ...
    path("sheets/<object_id>/hidden", views.view_toggle_sheet_hidden, name="toggle_sheet_hidden"),
    ...
    path("maps/<object_id>/hidden", views.view_toggle_map_hidden, name="toggle_map_hidden"),
    ...
    path("<active>/<object_id>/hidden", views.view_toggle_hidden, name="toggle_hidden"),
