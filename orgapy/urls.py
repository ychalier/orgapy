...
urlpatterns = [
    ...
    path("projects/archive", views.view_projects_archive, name="projects_archive"),
    path("projects/<object_id>", views.view_project, name="project"),
    path("projects/<object_id>/unarchive", views.view_unarchive_project, name="unarchive_project"),
