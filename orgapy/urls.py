...
urlpatterns = [
    ...
    path("categories/<name>/edit", views.view_edit_category, name="edit_category"), # TODO: deprecated
    path("categories/<name>/delete", views.view_delete_category, name="delete_category"), # TODO: deprecated
    ...
    path("trash/restore", views.view_restore_all_documents, name="restore_all"), # TODO: deprecated
    path("trash/destroy", views.view_destroy_all_documents, name="destroy_all"), # TODO: deprecated
